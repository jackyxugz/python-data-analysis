...
def get_order(file):
    ...
    df1['店铺'] = df1['店铺'].apply(lambda x:x.replace("D:\沙井\财务账单\\2022\抖音\\2022.01\订单\\","").replace(
        "（抖音小店）订单202110-原表.xlsx","").replace("/Users/maclove/Downloads/抖音报表/抖音/2021.11/订单/",""))
...
def split_table(file1,file2,file3):
    ...
    df_qty = pd.read_excel("/itdd/zengyanghui/sku_qty.xlsx")
...
if __name__ == "__main__":
    ...
    # costs_file = r"D:\南山\抖音报表\抖音成本(1)(3).xlsx"
